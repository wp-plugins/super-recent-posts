 ...
 * Description: Widget that can display recent posts from multiple categories, taxonomies, custom post types.
 * Version: 0.1
 * Author: Hmayak Tigranyan
 * Author URI: http://www.hmayaktigranyan.com/
 * Tags: custom post types,recent taxonomy posts,recent custom posts, post types, latest posts, sidebar widget, plugin
 * License: GPL
    ...
    function widget($args, $instance) {
        ...
        if ($posts_query->have_posts()) : while ($posts_query->have_posts()) : $posts_query->the_post();
                ...
                <div class="super_recent_posts_item">
                    <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" class="super_recent_posts_item_title"><?php the_title(); ?></a>
